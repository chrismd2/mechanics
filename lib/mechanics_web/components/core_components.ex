defmodule MechanicsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MechanicsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MechanicsWeb.Gettext, "errors", msg, opts)
    end
  end
